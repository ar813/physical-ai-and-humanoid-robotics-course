...
const config: Config = {
  ...
  tagline: 'Learn to build intelligent robots from basics to advanced AI integration',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/panaversity/physical-ai-and-humanoid-robotics-course',
            },
          ],
        },
      ],
